...
export const authOptions = {
    ...
    callbacks: {
        async signIn({ user, account, profile }) {
            // We can return true to allow sign in, or a string to redirect
            // Returning true here allows the normal flow to continue (creating session etc)
            // If we want to force redirect here it might conflict with client side redirects.
            // Keeping it simple: Allow sign in.
            return true;
        },
